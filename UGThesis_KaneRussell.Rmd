...
```{r}
# Check assumptions of one-way ANOVA
...
```{r}
# sample size calculation simulations for TBAI
...
```{r}
# sample size calculation simulations for SBAI
...
```{r}
# effect size and power summary for ANOVA
...
```{r}
# Calculate and plot TBAI confidence intervals
...
```{r}
# Calculate and plot SBAI confidence intervals
